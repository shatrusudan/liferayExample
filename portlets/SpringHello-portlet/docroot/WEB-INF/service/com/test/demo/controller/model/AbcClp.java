...
import com.test.demo.controller.service.ClpSerializer;
 ...
 */
public class AbcClp extends BaseModelImpl<Abc> implements Abc {
	public AbcClp() {
	}
	...
	public void setFooId(long fooId) {
		...
		if (_abcRemoteModel != null) {
			try {
				Class<?> clazz = _abcRemoteModel.getClass();

				Method method = clazz.getMethod("setFooId", long.class);

				method.invoke(_abcRemoteModel, fooId);
			}
			catch (Exception e) {
	...
	public void setCompanyId(long companyId) {
		...
		if (_abcRemoteModel != null) {
			try {
				...
				method.invoke(_abcRemoteModel, companyId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserId(long userId) {
		...
		if (_abcRemoteModel != null) {
			try {
				...
				method.invoke(_abcRemoteModel, userId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserName(String userName) {
		...
		if (_abcRemoteModel != null) {
			try {
				...
				method.invoke(_abcRemoteModel, userName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreateDate(Date createDate) {
		...
		if (_abcRemoteModel != null) {
			try {
				...
				method.invoke(_abcRemoteModel, createDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_abcRemoteModel != null) {
			try {
				...
				method.invoke(_abcRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setField1(String field1) {
		...
		if (_abcRemoteModel != null) {
			try {
				...
				method.invoke(_abcRemoteModel, field1);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setField2(boolean field2) {
		...
		if (_abcRemoteModel != null) {
			try {
				...
				method.invoke(_abcRemoteModel, field2);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setField3(int field3) {
		...
		if (_abcRemoteModel != null) {
			try {
				...
				method.invoke(_abcRemoteModel, field3);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setField4(Date field4) {
		...
		if (_abcRemoteModel != null) {
			try {
				...
				method.invoke(_abcRemoteModel, field4);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setField5(String field5) {
		...
		if (_abcRemoteModel != null) {
			try {
				...
				method.invoke(_abcRemoteModel, field5);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getAbcRemoteModel() {
		return _abcRemoteModel;
	}

	public void setAbcRemoteModel(BaseModel<?> abcRemoteModel) {
		_abcRemoteModel = abcRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _abcRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_abcRemoteModel,
	...
	public Abc toEscapedModel() {
		return (Abc)ProxyUtil.newProxyInstance(Abc.class.getClassLoader(),
			new Class[] { Abc.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		AbcClp clone = new AbcClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AbcClp)) {
			return false;
		}

		AbcClp abc = (AbcClp)obj;
	...
	private BaseModel<?> _abcRemoteModel;
}